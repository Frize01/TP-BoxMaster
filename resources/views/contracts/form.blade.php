        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <div>
                        <x-input-label for="price" value="Prix (sera affiché en € sur le contrat)" />
                    ...
                    <div>
                        <x-input-label for="deposit" value="Dépôt de garantie (sera affiché en € sur le contrat)" />
                        <x-text-input id="deposit" name="deposit" type="number" step="0.01"
                            class="mt-1 block w-full" :value="old('deposit', $contract->deposit)" required />
                        <x-input-error class="mt-2" :messages="$errors->get('deposit')" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-text-input id="date_start" name="date_start" type="date" class="mt-1 block w-full"
                            :value="old(
                                'date_start',
                                $contract->date_start ? $contract->date_start->format('Y-m-d') : '',
                            )" required />
