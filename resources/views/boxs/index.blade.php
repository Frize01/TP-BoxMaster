<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('box.create') }}" class="text-blue-500 px-2 py-1 bg-blue-100 hover:bg-blue-200 rounded-md hover:text-blue-700">
            Créer une box
        </a>
    </x-slot>
                      ...
                      <tr class="hover:bg-slate-50">
                          ...
                          <td class="p-4 border-b border-slate-200">
                            <div class="flex h-full gap-2">
                                <a href="{{ route('box.show', $box->id) }}" class="text-blue-500 px-2 py-1 bg-blue-100 rounded-md hover:text-blue-700">
                                    Voir
                                </a>
